...
const CONFIG = {
  ...
  UPGRADES: [
    ...
    { id: 'wealth',   name: 'WEALTH',      desc: '+20% NEX per kill',       icon: '⬢', color: '#00FFCC', maxLevel: 4, baseCost: 750,  costMult: 1.7  },
  ...
  ACHIEVEMENTS: [
    ...
    { id:'money_10k',   name:'CRIME PAYS',     desc:'Earn ⬢10,000 NEX',             icon:'⬢', stat:'moneyEarned',      threshold:10000 },
    { id:'money_50k',   name:'CRIME LORD',     desc:'Earn ⬢50,000 NEX',             icon:'⬢', stat:'moneyEarned',      threshold:50000 },
